...
function hocwp_theme_wc_enqueue_scripts() {
	wp_enqueue_style( 'hocwp-theme-woocommerce-style', HOCWP_THEME_CORE_URL . '/css/woocommerce' . HOCWP_THEME_CSS_SUFFIX );
}
...
if ( 'en_US' != $locale && 'en' != $locale ) {
	load_template( HOCWP_THEME_CORE_PATH . '/ext/woocommerce-translation.php' );
}